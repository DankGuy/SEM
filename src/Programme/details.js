...
const ProgrammeDetailsModal = ({ programDetails, closeModal, showModal, eligibilityList, selectedProgramId }) => {
    const modalStyle = {
    ...
    const eligibilityStatus = eligibilityList ? eligibilityList[selectedProgramId] : null;
    ...
    return (
      <div className="modal" style={modalStyle}>
        <div className="modal-content" style={modalContentStyle}>
          ...
          <h4 style={titleStyle}><box-icon type='solid' name='book' style={{width: "15px", height: "15px"}}></box-icon> Programme Overview</h4>
          ...
          <div className="flex-container" style={{ display: "flex", justifyContent: "space-between" }}>
              <div className="left-column" style={{ flex: 1, marginRight: "20px", marginLeft: "80px" }}>
                {/* show programme type */}
                <h4 style={titleStyle}><box-icon type='solid' name='bookmark' style={{width: "15px", height: "15px"}}></box-icon> Degree Type</h4>
                ...
                <h4 style={titleStyle}><box-icon type='solid' name='time' style={{width: "15px", height: "15px"}}></box-icon> Duration</h4>
              ...
              <div className="right-column" style={{ flex: 1, marginLeft: "80px" }}>
                ...
                <h4 style={titleStyle}><box-icon type='solid' name='location-plus' style={{width: "15px", height: "15px"}}></box-icon> Location</h4>
                ...
                <h4 style={titleStyle}><box-icon type='solid' name='calendar-alt' style={{width: "15px", height: "15px"}}></box-icon> Intake</h4>
          ...
          <h4 style={titleStyle}><box-icon name='list-ul' style={{width: "15px", height: "15px"}}></box-icon> Programme Outline</h4>
          ...
          <h4 style={titleStyle}><box-icon name='list-ul' style={{width: "15px", height: "15px"}}></box-icon> Elective</h4>
          ...
          <h4 style={titleStyle}><box-icon  name='list-ul' style={{width: "15px", height: "15px"}}></box-icon> Language, Mata Pelajaran Pengajian Umum (MPU) and Co-curricular Courses</h4>
          ...
          <h4 style={titleStyle}><box-icon type='solid' name='briefcase' style={{width: "15px", height: "15px"}}></box-icon> Career Prospects</h4>
          ...
          <h4 style={titleStyle}><box-icon type='solid' name='briefcase' style={{width: "15px", height: "15px"}}></box-icon> Minimum Entry Requirement</h4>      
          <img src='https://www.tarc.edu.my/files/focs/mer202305/8B7CEFC7-9F45-459A-B6D5-301BF0E2E806.png' style={imgStyle}></img>

          {/* eligibility status of the current user */}
          <h4 style={titleStyle}><box-icon  name='check' style={{width: "15px", height: "15px"}}></box-icon> Eligibility</h4>
          {eligibilityStatus !== null && (
            <p style={eligibilityStyle}>{`${eligibilityStatus ? 'Yes' : 'No'}`}</p>
          )}
        </div>
      </div>
    );
